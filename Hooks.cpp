...
void ClanTag()
{
	...
	if (!Interfaces::Engine->IsConnected() || !Interfaces::Engine->IsInGame())
		SetClanTag("Retronix.club", "Retronix.club");
	...
	case 1:
	{
		...
		switch (value) {
		case 0:SetClanTag("Retronix.club", "Retronix.club"); break;
		case 1:SetClanTag("Retronix.club", "Retronix.club"); break;
		}
		counter++;
	...
	case 2:
	{
		...
		switch (value) {
		case 0:SetClanTag("Re", "Retronix.club"); break;
		case 1:SetClanTag("Retr", "Retronix.club"); break;
		case 2:SetClanTag("Retron", "Retronix.club"); break;
		case 3:SetClanTag("Retronix", "Retronix.club"); break;
		case 4:SetClanTag("Retronix.c", "Retronix.club"); break;
		case 5:SetClanTag("Retronix.clu ", "Retronix.club"); break;
		case 6:SetClanTag("Retronix.club  ", "Retronix.club"); break;
		case 7:SetClanTag("tronix.club", "Retronix.club"); break;
		case 8:SetClanTag("onix.club", "Retronix.club"); break;
		case 9:SetClanTag("ix.club", "Retronix.club"); break;
		case 10:SetClanTag(".club", "Retronix.club"); break;
		case 11:SetClanTag("lub", "Retronix.club"); break;
		case 12:SetClanTag("b", "Retronix.club"); break;
		}
		counter++;
	...
	case 3:
	{
		...
		switch (value) {
		case 0:SetClanTag("           ", "KIDUAHOOK"); break;
		case 1:SetClanTag("K          ", "KIDUAHOOK"); break;
		case 2:SetClanTag("Ki         ", "KIDUAHOOK"); break;
		case 3:SetClanTag("Kid        ", "KIDUAHOOK"); break;
		case 4:SetClanTag("Kidu       ", "KIDUAHOOK"); break;
		case 5:SetClanTag("Kidua      ", "KIDUAHOOK"); break;
		case 6:SetClanTag("Kiduah     ", "KIDUAHOOK"); break;
		case 7:SetClanTag("Kiduahoo    ", "KIDUAHOOK"); break;
		case 8:SetClanTag("Kiduahook  ", "KIDUAHOOK"); break;
		case 9:SetClanTag("Kiduahook  ", "KIDUAHOOK"); break;
		case 10:SetClanTag("Kiduahoo    ", "KIDUAHOOK"); break;
		case 11:SetClanTag("Kiduah     ", "KIDUAHOOK"); break;
		case 12:SetClanTag("Kidua      ", "KIDUAHOOK"); break;
		case 13:SetClanTag("Kidu       ", "KIDUAHOOK"); break;
		case 14:SetClanTag("Kid        ", "KIDUAHOOK"); break;
		case 15:SetClanTag("Ki         ", "KIDUAHOOK"); break;
		case 16:SetClanTag("K          ", "KIDUAHOOK"); break;
		}
		counter++;
	...
	case 4:
	{
		...
		int value = ServerTime % 17;
		switch (value) {
		case 0:SetClanTag("           ", "sippin' skeet"); break;
		case 1:SetClanTag("s          ", "sippin' skeet"); break;
		case 2:SetClanTag("si         ", "sippin' skeet"); break;
		case 3:SetClanTag("sip        ", "sippin' skeet"); break;
		case 4:SetClanTag("sipp       ", "sippin' skeet"); break;
		case 5:SetClanTag("sippi      ", "sippin' skeet"); break;
		case 6:SetClanTag("sippin     ", "sippin' skeet"); break;
		case 7:SetClanTag("sippin'    ", "sippin' skeet"); break;
		case 8:SetClanTag("sippin'   ", "sippin' skeet"); break;
		case 9:SetClanTag("sippin' s  ", "sippin' skeet"); break;
		case 10:SetClanTag("sippin' sk    ", "sippin' skeet"); break;
		case 11:SetClanTag("sippin' ske     ", "sippin' skeet"); break;
		case 12:SetClanTag("sippin' skee      ", "sippin' skeet"); break;
		case 13:SetClanTag("sippin' skeet       ", "sippin' skeet"); break;
		}
		counter++;
	...
	case 5:
	{
		...
		switch (value) {
		case 0:SetClanTag("           ", "Killit Beta"); break;
		case 1:SetClanTag("s          ", "Killit Beta"); break;
		case 2:SetClanTag("si         ", "Killit Beta"); break;
		case 3:SetClanTag("sip        ", "Killit Beta"); break;
		case 4:SetClanTag("sipp       ", "Killit Beta"); break;
		case 5:SetClanTag("sippi      ", "Killit Beta"); break;
		case 6:SetClanTag("sippin     ", "Killit Beta"); break;
		case 7:SetClanTag("sippin'    ", "Killit Beta"); break;
		case 8:SetClanTag("sippin'   ", "Killit Beta"); break;
		case 9:SetClanTag("sippin' s  ", "Killit Beta"); break;
		case 10:SetClanTag("sippin' sk    ", "Killit Beta"); break;
		case 11:SetClanTag("sippin' ske     ", "Killit Beta"); break;
		case 12:SetClanTag("sippin' skee      ", "Killit Beta"); break;
		case 13:SetClanTag("sippin' skeet       ", "Killit Beta"); break;
		}
		counter++;
...
bool __stdcall CreateMoveClient_Hooked(float frametime, CUserCmd* pCmd)
{
	...
	if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame() && pLocal)
	{
		...
		switch (Menu::Window.MiscTab.SeeTpangle.GetIndex())
		{
		case 0:
			if (bSendPacket)
...
void __fastcall PaintTraverse_Hooked(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	...
	{
		if (Menu::Window.VisualsTab.ManualaaIndicator.GetState())
		{
			int W, H, cW, cH;
			...
			if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame())
			{
				...
				{
					if (GetKeyState(Menu::Window.RageBotTab.SWSwitchKey.GetKey()))
					{
						Render::Text(cW + 34, cH - 20, Color(255, 255, 255, 160), Render::Fonts::aaindicator, L">");
						Render::Text(cW - 64, cH - 20, Color(255, 255, 0, 160), Render::Fonts::aaindicator, L"<");
					}
					else
					{
						Render::Text(cW + 34, cH - 20, Color(255, 255, 0, 160), Render::Fonts::aaindicator, L">");
						Render::Text(cW - 64, cH - 20, Color(255, 255, 255, 160), Render::Fonts::aaindicator, L"<");
					}
				}
				else
				{
		...
		if (Menu::Window.LegitBotTab.legitaa.GetIndex() == 2)
		{
			int W, H, cW, cH;
			Interfaces::Engine->GetScreenSize(W, H);
			cW = W / 2;
			...
			if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame())
			{
				if (Menu::Window.LegitBotTab.legitaa.GetIndex() == 2)
				{
					if (GetKeyState(Menu::Window.LegitBotTab.legitaaswitch.GetKey()))
					{
						Render::Text(cW + 300, cH - 20, Color(255, 255, 255, 160), Render::Fonts::LBY, L"Right");
						Render::Text(cW - 326, cH - 20, Color(0, 255, 0, 160), Render::Fonts::LBY, L"Left");
					}
					else
					{
						Render::Text(cW + 300, cH - 20, Color(0, 255, 0, 160), Render::Fonts::LBY, L"Right");
						Render::Text(cW - 326, cH - 20, Color(255, 255, 255, 160), Render::Fonts::LBY, L"Left");
					}
				}
				else
				{
		...
		if (Menu::Window.VisualsTab.LBYIdicador.GetState())
		{
			...
			if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame())
				if (pCmd->viewangles.y - *localplayer->GetLowerBodyYawTarget() >= -35 && pCmd->viewangles.y - *localplayer->GetLowerBodyYawTarget() <= 35)
					...
					Render::Text(10, scrn.bottom - 80, Color(0, 255, 95, 255), Render::Fonts::LBY, "LBY");
		}
	

			{

				Render::Text(30, 15, Color(0, 77, 230, 255), Render::Fonts::watermarkusfontus, ("Retronix.club"));

			}
			if (Menu::Window.VisualsTab.Angleinfo.GetState())
			{
				char bufferLineLBY[64];
				sprintf_s(bufferLineLBY, "LBY:  %.1f", lineLBY);
				Render::Text(50, 19, Color(255, 255, 255, 255), Render::Fonts::ESP, bufferLineLBY);

				char bufferlineRealAngle[64];
				sprintf_s(bufferlineRealAngle, "Real:  %.1f", lineRealAngle);
				Render::Text(50, 29, Color(0, 255, 15, 255), Render::Fonts::ESP, bufferlineRealAngle);

				char bufferlineFakeAngle[64];
				sprintf_s(bufferlineFakeAngle, "Fake:  %.1f", lineFakeAngle);
				Render::Text(50, 39, Color(255, 178, 100, 255), Render::Fonts::ESP, bufferlineFakeAngle);
			} 
...
void StartPrediction(IClientEntity* LocalPlayer, CUserCmd* pCmd)
{
	...
	if (LocalPlayer->IsAlive() && Menu::Window.RageBotTab.EnginePrediction.GetState() && !done)
	{
	...
	bool DontDraw = false;
		...
		if (strstr(ModelName, "models/player"))
		{
			if (pLocal && pModelEntity && ChamsStyle != 0)
			{
				...
				if ((Menu::Window.VisualsTab.FiltersAll.GetState() || pModelEntity->GetTeamNum() != pLocal->GetTeamNum()))
				{
					...
					if (pOwner)
					{
						if (pOwner == pLocal)
						{
							...
							for (size_t i = 0; weps[i] != nullptr; i++) {
								...
								if (Menu::Window.Skins.SkinEnable.GetState())
								{
									int Model = Menu::Window.Skins.KnifeModel.GetIndex();

									int M41S = Menu::Window.Skins.M41SSkin.GetIndex();
									int M4A4 = Menu::Window.Skins.M4A4Skin.GetIndex();
									int AK47 = Menu::Window.Skins.AK47Skin.GetIndex();
									int AWP = Menu::Window.Skins.AWPSkin.GetIndex();
									int GLOCK = Menu::Window.Skins.GLOCKSkin.GetIndex();
									int USPS = Menu::Window.Skins.USPSSkin.GetIndex();
									int DEAGLE = Menu::Window.Skins.DEAGLESkin.GetIndex();
									int FIVE7 = Menu::Window.Skins.FIVESEVENSkin.GetIndex();
									int AUG = Menu::Window.Skins.AUGSkin.GetIndex();
									int FAMAS = Menu::Window.Skins.FAMASSkin.GetIndex();
									int G3SG1 = Menu::Window.Skins.G3SG1Skin.GetIndex();
									int Galil = Menu::Window.Skins.GALILSkin.GetIndex();
									int M249 = Menu::Window.Skins.M249Skin.GetIndex();
									int MAC10 = Menu::Window.Skins.MAC10Skin.GetIndex();
									int P90 = Menu::Window.Skins.P90Skin.GetIndex();
									int UMP45 = Menu::Window.Skins.UMP45Skin.GetIndex();
									int XM1014 = Menu::Window.Skins.XM1014Skin.GetIndex();
									int BIZON = Menu::Window.Skins.BIZONSkin.GetIndex();
									int MAG7 = Menu::Window.Skins.MAG7Skin.GetIndex();
									int NEGEV = Menu::Window.Skins.NEGEVSkin.GetIndex();
									int SAWEDOFF = Menu::Window.Skins.SAWEDOFFSkin.GetIndex();
									int TEC9 = Menu::Window.Skins.TECNINESkin.GetIndex();
									int P2000 = Menu::Window.Skins.P2000Skin.GetIndex();
									int MP7 = Menu::Window.Skins.MP7Skin.GetIndex();
									int MP9 = Menu::Window.Skins.MP9Skin.GetIndex();
									int NOVA = Menu::Window.Skins.NOVASkin.GetIndex();
									int P250 = Menu::Window.Skins.P250Skin.GetIndex();
									int SCAR20 = Menu::Window.Skins.SCAR20Skin.GetIndex();
									int SG553 = Menu::Window.Skins.SG553Skin.GetIndex();
									int SSG08 = Menu::Window.Skins.SSG08Skin.GetIndex();
									int Magnum = Menu::Window.Skins.r8skin.GetIndex();
									int CZ = Menu::Window.Skins.CZSkin.GetIndex();
									int dualies = CZ = Menu::Window.Skins.DUALSSkin.GetIndex();
								...
								if (pEntity->GetClientClass()->m_ClassID == (int)CSGOClassID::CKnife)
								{
									...
									if (Model == 0) // Bayonet
									{
										...
										*pWeapon->m_AttributeManager()->m_Item()->ItemDefinitionIndex() = 500;
										...
										int Skin = Menu::Window.Skins.KnifeSkin.GetIndex();
