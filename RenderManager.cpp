...
void Render::Initialise()
{
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::LBY, "Arial", 30, 500, 0, 0, FONTFLAG_ANTIALIAS );
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::watermarkusfontus, "Impact Regular", 30, 500, 0, 0, FONTFLAG_ANTIALIAS);
